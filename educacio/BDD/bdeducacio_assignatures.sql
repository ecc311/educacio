CREATE DATABASE  IF NOT EXISTS `bdeducacio` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `bdeducacio`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: bdeducacio
-- ------------------------------------------------------
...
CREATE TABLE `assignatures` (
  ...
  PRIMARY KEY (`idassignatures`),
  CONSTRAINT `id` FOREIGN KEY (`idassignatures`) REFERENCES `alumne` (`idalumne`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-02-12 12:21:56
